"""
1. Create a function which returns the number of true values 
...
"""
"""
2. Create a function that validates whether a number n is within 
...
"""
"""
5. Create a function that takes a string and censors words over
...
"""
"""
6. Given a sentence, create a function that replaces every "a" 
as an article with "an absolute". It should return the same string 
without any change if it doesn't have any "a".
...
"""
"""
8. Given a string of numbers separated by a comma and space, 
...
"""
"""
9. Create a function that takes a string road
and returns the car that's in first place. 
...
"""
"""
10. Create a function that takes an array of numbers between 1 and 10 
