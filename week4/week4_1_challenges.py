...
# 3. Write a function that returns the string "something" joined with a space
...
relative_name = input("\nWhat's your name? ")
TEXT = "Luke, I am your "
dad = relative_name == "Darth Vader"
sis = relative_name == "Leia"
bro = relative_name == "Han"
dr = relative_name == "R2D2"
print((TEXT + "father") * dad)
# + ((TEXT + "sister") * sis)
# + ((TEXT + "brother in law") * bro)
# + ((TEXT + "droid") * dr))
